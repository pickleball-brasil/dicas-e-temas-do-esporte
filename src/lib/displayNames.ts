...
export const DISPLAY_NAMES: Record<string, string> = {
  ...
  "roteiro-aula-dinks-aceleracao": "Roteiro: Dinks e Aceleração",
  "roteiro-aula-terceira-bola": "Roteiro: Terceira Bola",
  "roteiro-aula-drive": "Roteiro: Drive",
  "roteiro-aula-drop": "Roteiro: Drop",
  "roteiro-aula-tomada-decisao": "Roteiro: Tomada de Decisão",
  "roteiro-aula-saque-devolucao": "Roteiro: Saque e Devolução",
  "roteiro-aula-jogo-das-porcentagens": "Roteiro: Jogo das Porcentagens",
